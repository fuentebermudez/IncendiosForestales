...
def get_ndvi_serie(lat,lon,initial_date,final_date):
    ...
    #'https://modis.ornl.gov/rst/api/v1/MOD13Q1/subset?latitude=35.958767&longitude=-84.287433&startDate=A2018049&endDate=A2018049&band=250m_16_days_NDVI&kmAboveBelow=5&kmLeftRight=5'
    response = rq.get(
...
fecha_inicial = format_modis_date(Utilidades.substract_days("2008-01-01"))
fecha_final = format_modis_date("2008-01-01")
a=get_ndvi_serie("42.954656","-2.325719","A2002238","A2002243")
print(np.mean(a))
